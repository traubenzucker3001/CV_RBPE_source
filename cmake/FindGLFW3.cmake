...
IF (MINGW)
    FIND_PATH( GLFW3_INCLUDE_PATH GLFW/glfw3.h
        ${DEPENDENCIES_PATH}/glfw-3.0.2.bin.WIN32/include
    )

    FIND_LIBRARY( GLFW3_LIBRARY
        NAMES glfw3dll
        PATHS
        ${DEPENDENCIES_PATH}/glfw-3.0.2.bin.WIN32/lib-mingw
    )

    execute_process(COMMAND ${CMAKE_COMMAND}  -E  copy_if_different
        ${DEPENDENCIES_PATH}/glfw-3.0.2.bin.WIN32/lib-mingw/glfw3.dll
...
ELSEIF (MSVC)
    ...
    FIND_LIBRARY( GLFW3_LIBRARY
        NAMES glfw3dll
        PATHS
        ${DEPENDENCIES_PATH}/glfw-3.0.2.bin.WIN32/lib-msvc110
    )
